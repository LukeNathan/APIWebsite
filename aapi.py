...
def main(event):	# use API to get place info
	...
	if (response.status_code == 200):
		...
		ofile = open("HomeApi.html", "w")
		ofile.write("<h1>" + datajson[countryNumber]['name'] + "</h1>")
		ofile.write("<p>" + datajson[countryNumber]['capital'] + "</p>")
...
def localwindow():
	...
	l1 = Label(imgframe,text="Country Information Index", font=("Calibri", 30), fg="#414245")
	l2 = Label(imgframe, text="Display countries and territories with their\ncapital, continent, language, and more", font=("Calibri", 15), fg="#414245")
